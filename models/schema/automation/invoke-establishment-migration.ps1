...
@(
    $row.urn, $row.ukprn, $row.local_authority_code, $row.government_office_region_code, $row.district_administrative_code, $row.administrative_ward_code, $row.parliamentary_constituency_code, $row.lsoa_code, $row.msoa_code, $row.urban_rural_code, $row.establishment_number,
    $row.name, $row.website, $row.telephone_number, $row.source_establishment_status_code, $row.open_date, $row.close_date,
    $row.source_reason_establishment_opened_code, $row.reason_establishment_opened, $row.source_reason_establishment_closed_code,
    $row.reason_establishment_closed, $row.last_changed_date, $row.source_establishment_type_code, $row.source_education_phase_code,
