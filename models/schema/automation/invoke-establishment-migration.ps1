...
@(
    $row.urn, $row.ukprn, $row.local_authority_code, $row.government_office_region_code, $row.district_administrative_code, $row.administrative_ward_code, $row.parliamentary_constituency_code, $row.lsoa_code, $row.msoa_code, $row.establishment_number,
