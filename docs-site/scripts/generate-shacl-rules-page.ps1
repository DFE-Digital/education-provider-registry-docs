param(
    [string]$ShaclPath = (Join-Path (Join-Path $PSScriptRoot "..\..") (Join-Path "models" (Join-Path "establishment" "establishment-shacl.ttl"))),
...
$lines = @(
    ...
    "",
    "This page documents current GIAS field applicability rules by establishment type. It is generated from ``models/establishment/establishment-shacl.ttl`` during the site build. Do not edit this file directly.",
    "",
...
$lines += '---'
$lines += ''
$lines += "Source: [``models/establishment/establishment-shacl.ttl``](https://github.com/DFE-Digital/education-provider-registry-docs/blob/main/models/establishment/establishment-shacl.ttl)"
