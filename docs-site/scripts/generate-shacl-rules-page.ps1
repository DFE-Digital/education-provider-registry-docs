...
$lines += '---'
$lines += ''
$lines += "Source: [``models/establishment-details-shacl.ttl``](https://github.com/DFE-Digital/education-provider-registry-docs/blob/main/models/establishment-details-shacl.ttl)"
