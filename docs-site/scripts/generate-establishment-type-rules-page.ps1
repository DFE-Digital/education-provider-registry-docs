...
$lines.Add('')
$lines.Add('This page is generated from ``models/education-provider-shacl.ttl`` during the site build. Do not edit this file directly.')
$lines.Add('')
...
$lines.Add('---')
$lines.Add('')
$lines.Add("Source: [``models/education-provider-shacl.ttl``](https://github.com/DFE-Digital/education-provider-registry-docs/blob/main/models/education-provider-shacl.ttl)")
