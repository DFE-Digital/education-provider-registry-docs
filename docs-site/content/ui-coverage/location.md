...
| Field | `epr:` concept |
| --- | --- |
| District | [`epr:DistrictAdministrative`](../../vocabulary/DistrictAdministrative/) |
| Easting | [`epr:Easting`](../../vocabulary/Easting/) |
| Government office region (GOR) | [`epr:GovernmentOfficeRegion`](../../vocabulary/GovernmentOfficeRegion/) |
| GSS local authority code | [`epr:GssLocalAuthorityCode`](../../vocabulary/GssLocalAuthorityCode/) |
| Lower super output area (LSOA) | [`epr:LowerLayerSuperOutputArea`](../../vocabulary/LowerLayerSuperOutputArea/) |
| Middle super output area (MSOA) | [`epr:MiddleLayerSuperOutputArea`](../../vocabulary/MiddleLayerSuperOutputArea/) |
| Northing | [`epr:Northing`](../../vocabulary/Northing/) |
| Parliamentary constituency | [`epr:ParliamentaryConstituency`](../../vocabulary/ParliamentaryConstituency/) |
| Unique property reference number (UPRN) | [`epr:UniquePropertyReferenceNumber`](../../vocabulary/UniquePropertyReferenceNumber/) |
| Urban / rural description | [`epr:UrbanRuralClassification`](../../vocabulary/UrbanRuralClassification/) |
| Ward | [`epr:AdministrativeWard`](../../vocabulary/AdministrativeWard/) |
